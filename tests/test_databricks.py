...
class TestEnsureDatabricksCliVersion:
    ...
    def test_auto_upgrades_when_version_too_old(self, tmp_path, monkeypatch):
        ...
        env = self._fake_databricks(tmp_path, "Databricks CLI v1.11.0")
        monkeypatch.setattr("os.environ", env)
        upgraded = []
        monkeypatch.setattr(
            db_mod,
